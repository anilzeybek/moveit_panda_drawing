...
const float point_matrix[11][13][3] = {
    {{0.3, -0.4, 0.8}, {0.25, -0.4, 0.8}, {0.2, -0.4, 0.8}, {0.15, -0.4, 0.8}, {0.1, -0.4, 0.8}, {0.05, -0.4, 0.8}, {0, -0.4, 0.8}, {-0.05, -0.4, 0.8}, {-0.1, -0.4, 0.8}, {-0.15, -0.4, 0.8}, {-0.2, -0.4, 0.8}, {-0.25, -0.4, 0.8}, {-0.3, -0.4, 0.8}},
    {{0.3, -0.4, 0.75}, {0.25, -0.4, 0.75}, {0.2, -0.4, 0.75}, {0.15, -0.4, 0.75}, {0.1, -0.4, 0.75}, {0.05, -0.4, 0.75}, {0, -0.4, 0.75}, {-0.05, -0.4, 0.75}, {-0.1, -0.4, 0.75}, {-0.15, -0.4, 0.75}, {-0.2, -0.4, 0.75}, {-0.25, -0.4, 0.75}, {-0.3, -0.4, 0.75}},
    {{0.3, -0.4, 0.7}, {0.25, -0.4, 0.7}, {0.2, -0.4, 0.7}, {0.15, -0.4, 0.7}, {0.1, -0.4, 0.7}, {0.05, -0.4, 0.7}, {0, -0.4, 0.7}, {-0.05, -0.4, 0.7}, {-0.1, -0.4, 0.7}, {-0.15, -0.4, 0.7}, {-0.2, -0.4, 0.7}, {-0.25, -0.4, 0.7}, {-0.3, -0.4, 0.7}},
    {{0.3, -0.4, 0.65}, {0.25, -0.4, 0.65}, {0.2, -0.4, 0.65}, {0.15, -0.4, 0.65}, {0.1, -0.4, 0.65}, {0.05, -0.4, 0.65}, {0, -0.4, 0.65}, {-0.05, -0.4, 0.65}, {-0.1, -0.4, 0.65}, {-0.15, -0.4, 0.65}, {-0.2, -0.4, 0.65}, {-0.25, -0.4, 0.65}, {-0.3, -0.4, 0.65}},
    {{0.3, -0.4, 0.6}, {0.25, -0.4, 0.6}, {0.2, -0.4, 0.6}, {0.15, -0.4, 0.6}, {0.1, -0.4, 0.6}, {0.05, -0.4, 0.6}, {0, -0.4, 0.6}, {-0.05, -0.4, 0.6}, {-0.1, -0.4, 0.6}, {-0.15, -0.4, 0.6}, {-0.2, -0.4, 0.6}, {-0.25, -0.4, 0.6}, {-0.3, -0.4, 0.6}},
    {{0.3, -0.4, 0.55}, {0.25, -0.4, 0.55}, {0.2, -0.4, 0.55}, {0.15, -0.4, 0.55}, {0.1, -0.4, 0.55}, {0.05, -0.4, 0.55}, {0, -0.4, 0.55}, {-0.05, -0.4, 0.55}, {-0.1, -0.4, 0.55}, {-0.15, -0.4, 0.55}, {-0.2, -0.4, 0.55}, {-0.25, -0.4, 0.55}, {-0.3, -0.4, 0.55}},
    {{0.3, -0.4, 0.5}, {0.25, -0.4, 0.5}, {0.2, -0.4, 0.5}, {0.15, -0.4, 0.5}, {0.1, -0.4, 0.5}, {0.05, -0.4, 0.5}, {0, -0.4, 0.5}, {-0.05, -0.4, 0.5}, {-0.1, -0.4, 0.5}, {-0.15, -0.4, 0.5}, {-0.2, -0.4, 0.5}, {-0.25, -0.4, 0.5}, {-0.3, -0.4, 0.5}},
    {{0.3, -0.4, 0.45}, {0.25, -0.4, 0.45}, {0.2, -0.4, 0.45}, {0.15, -0.4, 0.45}, {0.1, -0.4, 0.45}, {0.05, -0.4, 0.45}, {0, -0.4, 0.45}, {-0.05, -0.4, 0.45}, {-0.1, -0.4, 0.45}, {-0.15, -0.4, 0.45}, {-0.2, -0.4, 0.45}, {-0.25, -0.4, 0.45}, {-0.3, -0.4, 0.45}},
    {{0.3, -0.4, 0.4}, {0.25, -0.4, 0.4}, {0.2, -0.4, 0.4}, {0.15, -0.4, 0.4}, {0.1, -0.4, 0.4}, {0.05, -0.4, 0.4}, {0, -0.4, 0.4}, {-0.05, -0.4, 0.4}, {-0.1, -0.4, 0.4}, {-0.15, -0.4, 0.4}, {-0.2, -0.4, 0.4}, {-0.25, -0.4, 0.4}, {-0.3, -0.4, 0.4}},
    {{0.3, -0.4, 0.35}, {0.25, -0.4, 0.35}, {0.2, -0.4, 0.35}, {0.15, -0.4, 0.35}, {0.1, -0.4, 0.35}, {0.05, -0.4, 0.35}, {0, -0.4, 0.35}, {-0.05, -0.4, 0.35}, {-0.1, -0.4, 0.35}, {-0.15, -0.4, 0.35}, {-0.2, -0.4, 0.35}, {-0.25, -0.4, 0.35}, {-0.3, -0.4, 0.35}},
    {{0.3, -0.4, 0.3}, {0.25, -0.4, 0.3}, {0.2, -0.4, 0.3}, {0.15, -0.4, 0.3}, {0.1, -0.4, 0.3}, {0.05, -0.4, 0.3}, {0, -0.4, 0.3}, {-0.05, -0.4, 0.3}, {-0.1, -0.4, 0.3}, {-0.15, -0.4, 0.3}, {-0.2, -0.4, 0.3}, {-0.25, -0.4, 0.3}, {-0.3, -0.4, 0.3}},
};
